package asri_tools.devalkhatech.com.asri.services;
...
public class SampleBC extends BroadcastReceiver {
    ...
    public void onReceive(final Context context, Intent intent) {
        ...
        //Toast.makeText(context, "Broadcast Service Running for " + noOfTimes + " times", Toast.LENGTH_SHORT).show();
        AsyncHttpClient client = new AsyncHttpClient();
        RequestParams params = new RequestParams();
        // Checks if new records are inserted in Remote MySQL DB to proceed with Sync operation
        //client.post("http://10.0.2.2/androwebservice/getdbrowcount.php",params ,new AsyncHttpResponseHandler() {
        client.post("http://192.168.1.33/aang/mysqlsqlitesync/getdbrowcount.php",params ,new AsyncHttpResponseHandler() {
