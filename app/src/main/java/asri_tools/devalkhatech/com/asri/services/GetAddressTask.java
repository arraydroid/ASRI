...
/**
 * Created by Array-PC on 18-Mar-16.
 */
...
import asri_tools.devalkhatech.com.asri.fragment.SalesAttendance;
...
public class GetAddressTask extends AsyncTask<String, Void, String> {
    ...
    private SalesAttendance activity;

    public GetAddressTask(SalesAttendance activity) {
        super();
